                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="descricao_cse" id="descricao_cse" rows="4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5">{{ old('descricao_cse') }}</textarea>
                            @error('descricao_cse')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
