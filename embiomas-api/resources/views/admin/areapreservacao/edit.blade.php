                    ...
                    <div class="space-y-6">
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                <label for="tipoap_id" class="block text-sm font-medium text-gray-900">Tipo de
                                    Área de Preservação</label>
                        ...
                        <div>
                            ...
                            <textarea name="descricao_ap" id="descricao_ap" rows="4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5">{{ old('descricao_ap', $area_preservacao->descricao_ap) }}</textarea>
                            @error('descricao_ap')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        @if ($area_preservacao->imagem_ap)
                            <div>
                                ...
                                <img src="{{ asset('storage/' . $area_preservacao->imagem_ap) }}"
                                    ...
                                    class="mt-2 h-40 w-auto rounded-md">
                            </div>
                        @endif
                        <div>
                            <label for="imagem_ap" class="block text-sm font-medium text-gray-700">Substituir Imagem
                                (Opcional)</label>
