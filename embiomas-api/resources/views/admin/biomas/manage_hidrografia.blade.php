        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="flex justify-between items-center m-2">
                    <h2 class="font-semibold  text-xl text-black leading-tight">Crie ou altere a hidrografia</h2>
                        ...
                        <div
                            ...
                            <div class="flex-grow p-3 flex flex-col justify-between">
                                <div>
                                    ...
                                    <h4 class="font-bold text-gray-800 truncate" title="{{ $hidrografias->nome_hidrografia }}">
